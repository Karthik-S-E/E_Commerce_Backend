...
import com.myProject.e_Commerce.model.Cart;
import com.myProject.e_Commerce.model.CartItem;
import com.myProject.e_Commerce.model.Product;
import com.myProject.e_Commerce.payload.CartDTO;
import com.myProject.e_Commerce.payload.ProductDTO;
import com.myProject.e_Commerce.repositories.CartItemRepository;
import com.myProject.e_Commerce.repositories.CartRepository;
import com.myProject.e_Commerce.repositories.ProductRepository;
...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO updateProductQuantityInCart(Long productId, Integer quantity) {
        ...
        if(newQuantity<0)
        {
            throw new APIException("The resulting quantity cannot be a negative");
        }
        if(newQuantity==0)
        {
